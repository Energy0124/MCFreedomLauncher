...
public class LauncherConstants {
    ...
    static final int VERSION_MINIMUM_SUPPORTED_BOOTSTRAP = 4;
    ...
    static final String URL_BOOTSTRAP_DOWNLOAD = "https://s3.amazonaws.com/Minecraft.Download/launcher/Minecraft";
    ...
    static final String MESSAGE_LAUNCHER_NEWER_VERSION_USED = "It looks like you've used a newer launcher than this one! If you go back to using this one, we will need to reset your configuration. Do you still want to use this version of the launcher and have the settings reset?";
    static final String MESSAGE_LAUNCHER_OUTDATED = "Sorry, but your launcher is outdated! Please download the newer launcher!";
